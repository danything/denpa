 ...
 * ## 常に解く
 *
 * 見ている人がデータ放送を開いていなくても回す。**実機の録画で測って、放送の
 * 17 Mbit/s に対して1コアの 1.8%** (83MB を 0.69秒)。映像を焼く手間に埋もれる。
 *
 * 開いたときだけ回す形にすると、**開いてから絵が出るまでカルーセルが一周するのを
 * 待つ**ことになる。大きいモジュールほど間隔が空くので、待たせる時間が番組ごとに
 * 変わる。それを避けるほうが 1.8% より価値がある。
 *
